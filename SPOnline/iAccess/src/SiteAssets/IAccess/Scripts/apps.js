...
var userIdValue = "";
var itemID = "";
var userIdCollection = new Array();
...
blankapp.controller("clientcontroll", ['$scope', '$timeout', '$q', function ($scope, $timeout, $q) {
    ...
    vm.usersEmployee = [_spPageContextInfo.userId.toString()];
    //Simulate a service
    // vm.userLookupService1 = function (q) 
    // {
    //     var d = $q.defer();
    //     //debugger;
    //     $timeout(function () {
    ...
    //             return a.Email==r.toString().split('/')[1];
    //             //return r.test(a.Email);
    //         }).slice(0, 10));
    //         d.resolve(response);
    //     }, 100);
    //     return d.promise;
    ...
    //New Code  
    $scope.$watch('ctrl.usersEmployee', function (newval, oldval) {
    ...
    function EditFormEntry() {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                vm.usersEmployee = _spPageContextInfo.userId;
                vm.userLookupService = function (q) {
                    var d = $q.defer();
                    $timeout(function () {
                        var list = contacts;
...
function saveNewRequest() {
    ...
    $(".md-contact-name").each(function () {
        userIdCollection.push(SP.FieldUserValue.fromUser($(this).text()));
    });
    GetRequestID();
    //var arrayOfPromises = [];
    //var arrayOfValues = ["TillidSP", "TillidSP"];
    //for (var i in arrayOfValues) {
    //    arrayOfPromises.push(GetUserTitle(arrayOfValues[i]));
    //}
    //window.userIdCollection = new Array();
    //$.when.apply($, arrayOfPromises).done(function (result) {
    //    debugger;
    //        //userIdCollection.push(SP.FieldLookupValue.set_lookupId(result));
    //        userIdCollection.push(SP.FieldUserValue.fromUser(result));
    //        //userIdCollection.push(result);  
    //});
}

//$.when(saveNewRequest()).then(function (result) {
...
//            return deferred.resolve(user.get_title());
//        },
...
//    //setTimeout(AddItemToList(), 100000);
//}
...
function AddItemToList() {
    ...
    listItem.set_item('ManagerID', userIdCollection);
...
//function AddItemToList() {
//    var item = [];
//    item.managerId = userIdCollection;
...
function GetRequestID() {
    ...
    GetLastItemId().then(function (result) {
        itemID = result + 1;
